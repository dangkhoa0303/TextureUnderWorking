...
import com.serenegiant.Square;
import com.serenegiant.Triangle;
...
//			if (DEBUG) Log.i(TAG, "onSurfaceCreated:Gl extensions: " + extensions);
			...
			triangle = new Triangle(context, hTex);
		}
		...
		public void onDrawFrame(final GL10 unused) {
			...
			triangle.Render(hTex);
			Log.d("CAMERA VIEW", ""+hTex);
